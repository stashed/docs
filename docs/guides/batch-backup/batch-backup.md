...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/batch-backup](/docs/examples/guides/batch-backup) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/batch-backup/mysql.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/batch-backup/wordpress.yaml
...
<figure align="center">
  <img alt="WordPress Setup Wizard" src="/docs/images/guides/batch-backup/wordpress-setup.png">
...
<figure align="center">
  <img alt="Sample Post" src="/docs/images/guides/batch-backup/sample-post.png">
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/batch-backup/appbinding.yaml
appbinding.appcatalog.appscode.com/wordpress-db
```

#### Prepare Backend

We are going to store our backed up data into a GCS bucket. We have to create a Secret with the necessary credentials and a Repository CR to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/guides/backends/overview.md).
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/batch-backup/repository.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/batch-backup/backupbatch.yaml
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/images/guides/batch-backup/backup-data.png">
...
<figure align="center">
  <img alt="Missing Sample Post" src="/docs/images/guides/batch-backup/wp_missing.png">
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/batch-backup/restorebatch.yaml
...
<figure align="center">
  <img alt="Restored Sample Post" src="/docs/images/guides/batch-backup/wp_restored.png">
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/batch-backup/restoresession.yaml
