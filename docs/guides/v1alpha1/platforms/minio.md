...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/minio](/docs/examples/platforms/minio) directory of [stashed/stash](https://github.com/stashed/stash) repository.
