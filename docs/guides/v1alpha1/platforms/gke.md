...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/gke](/docs/examples/platforms/gke) directory of [stashed/stash](https://github.com/stashed/stash) repository.
