...
```console
$ kubectl get repository -n demo sample-postgres-1 -o yaml
```
...
metadata:
  ...
  selfLink: /apis/stash.appscode.com/v1beta1/namespaces/demo/repositories/sample-postgres-1
...
sample-postgres-1   postgres-backup-11.2   */5 * * * *            3m5s
```
...
```console
$ kubectl get backupconfiguration -n demo sample-postgres-1 -o yaml
```
...
metadata:
  ...
  selfLink: /apis/stash.appscode.com/v1beta1/namespaces/demo/backupconfigurations/sample-postgres-1
...
```console
$ watch -n 1 kubectl get backupsession -n demo -l=stash.appscode.com/backup-configuration=sample-postgres-1

Every 1.0s: kubectl get backupsession -n demo -l=stash.appscode.com/backup-configuration=sample-postgres-1  workstation: Thu Aug  1 20:35:43 2019
NAME                           BACKUPCONFIGURATION   PHASE       AGE
sample-postgres-1-1564670101   sample-postgres-1     Succeeded   42s
```
...
```console
$ kubectl get repository -n demo sample-postgres-1
NAME                INTEGRITY   SIZE        SNAPSHOT-COUNT   LAST-SUCCESSFUL-BACKUP   AGE
sample-postgres-1   true        1.324 KiB   1                73s                      6m7s
```
...
$ kubectl get repository -n demo
NAME                INTEGRITY   SIZE        SNAPSHOT-COUNT   LAST-SUCCESSFUL-BACKUP   AGE
sample-postgres-1   true        1.324 KiB   1                2m3s                     6m57s
sample-postgres-2                                                                     15s
```
...
```console
$ kubectl get repository -n demo sample-postgres-2 -o yaml
```
...
metadata:
  ...
  selfLink: /apis/stash.appscode.com/v1beta1/namespaces/demo/repositories/sample-postgres-2
...
$ kubectl get backupconfiguration -n demo
NAME                TASK                   SCHEDULE      PAUSED   AGE
sample-postgres-1   postgres-backup-11.2   */5 * * * *            7m52s
sample-postgres-2   postgres-backup-10.6   */5 * * * *            70s
```
...
```console
$ watch -n 1 kubectl get backupsession -n demo -l=stash.appscode.com/backup-configuration=sample-postgres-2

Every 1.0s: kubectl get backupsession -n demo -l=stash.appscode.com/backup-configuration=sample-postgres-2  workstation: Thu Aug  1 20:55:40 2019
NAME                           BACKUPCONFIGURATION   PHASE       AGE
sample-postgres-2-1564671303   sample-postgres-2     Succeeded   37s
```
...
```console
$ kubectl get repository -n demo sample-postgres-2
NAME                INTEGRITY   SIZE        SNAPSHOT-COUNT   LAST-SUCCESSFUL-BACKUP   AGE
sample-postgres-2   true        1.324 KiB   1                52s                      19m
```
...
kubectl delete -n demo repository/sample-postgres-1
kubectl delete -n demo repository/sample-postgres-2
