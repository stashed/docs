...
>**Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/auto-backup/pvc](/docs/examples/guides/auto-backup/pvc) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/pvc/backupblueprint.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/pvc/nfs_pv.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/pvc/nfs_pvc.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/pvc/pod-1.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/pvc/pod-2.yaml
...
<figure align="center">
  <img alt="Backup data of PVC 'nfs-pvc' in GCS backend" src="/docs/images/guides/auto-backup/pvc/pvc_repo.png">
