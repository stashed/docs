...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/workload/backupblueprint.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/workload/deployment.yaml
...
<figure align="center">
  <img alt="Backup data in GCS backend" src="/docs/images/guides/auto-backup/workload/deployment_repo.png">
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/workload/statefulset.yaml
...
<figure align="center">
  <img alt="Backup data of `sts-demo` StatefulSet in GCS backend" src="/docs/images/guides/auto-backup/workload/statefulset_repo.png">
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/auto-backup/workload/daemonset.yaml
...
<figure align="center">
  <img alt="Backup data of `dmn-demo` DaemonSet in GCS backend" src="/docs/images/guides/auto-backup/workload/daemon_repo.png">
