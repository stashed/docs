...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/deployment/examples](/docs/guides/workloads/deployment/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="images/gcs_bucket_dep.png">
