...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/workloads/statefulset/statefulset.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/workloads/statefulset/repository.yaml
...
```bash
$ kubectl describe backupconfiguration -n demo ss-backup
```
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/images/guides/workloads/gcs_bucket_ss.png">
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/workloads/statefulset/recovered_statefulset.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/workloads/statefulset/adv_statefulset.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/workloads/statefulset/adv_restoresession.yaml
restoresession.stash.appscode.com/ss-restore created
```
