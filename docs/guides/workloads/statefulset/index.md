...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/statefulset/examples](/docs/guides/workloads/statefulset/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
