...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/daemonset/examples](/docs/guides/workloads/daemonset/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="images/gcs_bucket_dmn.png">
