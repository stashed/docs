...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/platforms/eks](/docs/examples/guides/platforms/eks) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/platforms/eks/pvc.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/platforms/eks/deployment.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/platforms/eks/repository.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/platforms/eks/backupconfiguration.yaml
...
<figure align="center">
  <img alt="Backup data in AWS s3 Bucket" src="/docs/images/guides/platforms/eks.png">
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/platforms/eks/recovered_deployment.yaml
...
```bash
$ kubectl apply -f https://github.com/stashed/docs/raw/{{< param "info.version" >}}/docs/examples/guides/platforms/eks/restoresession.yaml
