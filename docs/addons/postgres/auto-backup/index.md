...
Now, we are ready to backup our PostgreSQL databases using few annotations. You can check available auto-backup annotations for a database from [here](/docs/guides/auto-backup/database/index.md#available-auto-backup-annotations-for-database).
