---
title: Kubectl-Stash Delete
menu:
  docs_{{ .version }}:
    identifier: kubectl-stash-delete
    name: Kubectl-Stash Delete
...
* [kubectl-stash delete snapshot](/docs/reference/cli/kubectl-stash_delete_snapshot.md)	 - Delete a snapshot from repository backend
