...
- Learn how Stash backup databases using `Function-Task` model from [here](/docs/guides/addons/overview/index.md).
- Learn how Stash backup stand-alone PVC using `Function-Task` model from [here](/docs/guides/volumes/overview/index.md).
